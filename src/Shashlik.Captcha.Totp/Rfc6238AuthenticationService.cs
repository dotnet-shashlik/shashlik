...
// copy from https://github.com/dotnet/aspnetcore/blob/master/src/Identity/Extensions.Core/src/Rfc6238AuthenticationService.cs
...
namespace Shashlik.Captcha.Totp
{
    internal static class Rfc6238AuthenticationService
    {
        ...
        internal static void SetTimeStep(TimeSpan timeSpan)
        {
            _timestep = timeSpan;
        }

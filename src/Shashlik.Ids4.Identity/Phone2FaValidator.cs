...
namespace Shashlik.Ids4.Identity
{
    ...
    public class Phone2FaValidator : IExtensionGrantValidator
    {
        ...
        public Phone2FaValidator(ShashlikUserManager userManager, IOptions<Ids4IdentityOptions> ids4IdentityOptions,
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            if (!await _userManager.VerifyTwoFactorTokenAsync(user,
                _identityOptions.Value.Tokens.ChangePhoneNumberTokenProvider, token))
                errorCode = -4;

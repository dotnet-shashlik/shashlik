...
namespace Shashlik.Ids4.IdentityInt32
{
    ...
    public class ShashlikIds4IdentityOptions
    {
        ...
        /// </summary>
        public List<string> PasswordSignInSources { get; set; } =
        ...
        /// </summary>
        public List<string> CaptchaSignInSources { get; set; } =
            new List<string> {ShashlikIds4IdentityConsts.PhoneSource, ShashlikIds4IdentityConsts.EMailSource};
    }
}
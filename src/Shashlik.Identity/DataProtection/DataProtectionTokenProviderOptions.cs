...
// copy from https://github.com/dotnet/aspnetcore/blob/release/3.1/src/Identity/Core/src/DataProtectionTokenProviderOptions.cs
using System;

namespace Shashlik.Identity.DataProtection
{
    /// <summary>

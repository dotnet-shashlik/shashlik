...
{
    public class PostgreSqlDataProtectionConfigure : IAutowiredConfigureServices
    {
        public PostgreSqlDataProtectionConfigure(IOptions<PostgreSqlDataProtectionOptions> options)
        {
